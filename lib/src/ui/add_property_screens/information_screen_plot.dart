...
class InformationScreenPlot extends StatefulWidget {
  const InformationScreenPlot({super.key});

  @override
  State<InformationScreenPlot> createState() => _InformationScreenPlotState();
}

class _InformationScreenPlotState extends State<InformationScreenPlot> {
  var propertyType = "";
